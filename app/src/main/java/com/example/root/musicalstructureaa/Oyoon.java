...
public class Oyoon extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        moviesList.add(new song(R.drawable.oyoon, "Song 1" , "2013"));
        moviesList.add(new song(R.drawable.oyoon, "Song 2" , "2017"));
        moviesList.add(new song(R.drawable.oyoon, "Song 3" , "2016"));
        moviesList.add(new song(R.drawable.oyoon, "Song 4" , "2014"));
        moviesList.add(new song(R.drawable.oyoon, "Song 5" , "1999"));
        moviesList.add(new song(R.drawable.oyoon, "Song 6" , "1975"));
        moviesList.add(new song(R.drawable.oyoon, "Song 7" , "2011"));
        moviesList.add(new song(R.drawable.oyoon, "Song 8" , "2016"));
        moviesList.add(new song(R.drawable.oyoon, "Song 9" , "2011"));
